<template>
    <div class="notice-management-container auto-height-container">
        <vab-query-form>
            ...
            <vab-query-form-right-panel :span="12">
                <el-form inline :model="queryForm" @submit.prevent>
                    <el-form-item>
                        <el-input v-model.trim="queryForm.noticeTitle" clearable placeholder="公告标题" />
                    </el-form-item>
                    <el-form-item>
        ...
        <el-table v-loading="listLoading" border :data="list" @selection-change="setSelectRows">
            ...
            <el-table-column label="标题" prop="noticeTitle" show-overflow-tooltip min-width="180" />
            <el-table-column label="类型" prop="noticeType" show-overflow-tooltip width="90" />
            ...
            <el-table-column label="创建者" prop="createByName" show-overflow-tooltip width="100" />
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const fetchData = async () => {
                ...
                try {
                    const res = await listNotice(state.queryForm)
