...
(
    ...
    lon           float                 default 0,
    -- owner
    linker_name   varchar(512)          default null,
    linker_mobile varchar(32)           default null,
    -- device
...
create table slion_project_grant(
    ...
    -- basic information
    project_id    int8,
    grant_type    int4         not null default 1,
    grant_from    int8         not null default 0,
    grant_to      int8         not null default 0,
    -- common keys
    create_dept   int8,
    create_by     int8,
    create_time   timestamp             default current_timestamp,
...
create table slion_device(
    id           int8,
    -- basic information
    device_sn       varchar(512)    not null default '',
    device_type     int4            not null default 0,
    ...
    uptime          int4            not null default 0,
    ...
    mem_total       int8            not null default 0,
    mem_use         int8            not null default 0,
    mem_free        int8            not null default 0,
    disk_total      int8            not null default 0,
    disk_use        int8            not null default 0,
    disk_free       int8            not null default 0,
...
create table slion_device_network(
    id           int8,
    -- basic information
    device_id       int8                not null default 0,
    net_name        varchar(32)         not null default '',
...
create table slion_device_mac_import(
    ...
    mac_address1    varchar(32)         not null default '0:0:0:0:0:0',
    mac_address2    varchar(32)         not null default '0:0:0:0:0:0',
...
create table slion_device_frp(
    ...
    biz_key             varchar             not null default '',
    -- common keys
    create_dept   int8,
    create_by     int8,
    create_time   timestamp             default current_timestamp,
...
create table slion_frp_hosts(
    ...
    port                int4            not null default 80,
    remote_port         int4            not null default 0,
    biz_key             varchar(32)     unique not null,
    view_key            varchar(32)     unique not null,
    use_encryption      bool            not null default false,
    use_compression     bool            not null default false,
    plugin_user         varchar(128)    not null default '',
    plugin_pwd          varchar(128)    not null default '',
    status              int2            not null default 0::int2,
    -- common keys
    create_dept   int8,
    create_by     int8,
