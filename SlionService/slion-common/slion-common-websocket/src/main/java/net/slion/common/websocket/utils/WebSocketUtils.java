package net.slion.common.websocket.utils;
...
import net.slion.common.websocket.dto.WebSocketMessageDto;
import net.slion.common.websocket.holder.WebSocketSessionHolder;
...
import static net.slion.common.websocket.constant.WebSocketConstants.WEB_SOCKET_TOPIC;
...
//        }
        WebSocketMessageDto broadcastMessage = new WebSocketMessageDto();
        broadcastMessage.setMessage(webSocketMessage.getMessage());
        broadcastMessage.setSessionKeys(webSocketMessage.getSessionKeys());
        RedisUtils.publish(WEB_SOCKET_TOPIC, broadcastMessage);
//        RedisUtils.publish(WEB_SOCKET_TOPIC, broadcastMessage, consumer -> {
//            log.info(" WebSocket发送主题订阅消息topic:{} session keys:{} message:{}",
