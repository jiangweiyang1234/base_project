package net.slion.common.social.utils;
...
import net.slion.common.social.gitea.AuthGiteaRequest;
import net.slion.common.social.maxkey.AuthMaxKeyRequest;
import net.slion.common.social.topiam.AuthTopIamRequest;
