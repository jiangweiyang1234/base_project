...
import net.slion.common.core.domain.dto.StartProcessReturnDTO;
import net.slion.common.core.domain.dto.UserDTO;
import net.slion.common.core.enums.BusinessStatusEnum;
import net.slion.common.core.exception.ServiceException;
import net.slion.common.core.service.UserService;
import net.slion.common.core.utils.StreamUtils;
...
import net.slion.common.mybatis.utils.IdGeneratorUtil;
...
import net.slion.workflow.common.enums.TaskAssigneeType;
import net.slion.workflow.common.enums.TaskOperationEnum;
import net.slion.workflow.common.enums.TaskStatusEnum;
import net.slion.workflow.domain.FlowInstanceBizExt;
import net.slion.workflow.domain.bo.*;
import net.slion.workflow.domain.vo.FlowCopyVo;
import net.slion.workflow.domain.vo.FlowHisTaskVo;
import net.slion.workflow.domain.vo.FlowTaskVo;
import net.slion.workflow.domain.vo.NodeExtVo;
import net.slion.workflow.mapper.FlwCategoryMapper;
import net.slion.workflow.mapper.FlwInstanceBizExtMapper;
import net.slion.workflow.mapper.FlwTaskMapper;
import net.slion.workflow.service.IFlwCommonService;
import net.slion.workflow.service.IFlwNodeExtService;
import net.slion.workflow.service.IFlwTaskAssigneeService;
import net.slion.workflow.service.IFlwTaskService;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import java.util.*;

import static net.slion.workflow.common.constant.FlowConstant.*;
