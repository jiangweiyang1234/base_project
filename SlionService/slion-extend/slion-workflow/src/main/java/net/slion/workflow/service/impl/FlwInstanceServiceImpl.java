...
import net.slion.workflow.domain.bo.FlowCancelBo;
import net.slion.workflow.domain.bo.FlowInstanceBo;
import net.slion.workflow.domain.bo.FlowInvalidBo;
import net.slion.workflow.domain.bo.FlowVariableBo;
import net.slion.workflow.domain.vo.FlowHisTaskVo;
import net.slion.workflow.domain.vo.FlowInstanceVo;
import net.slion.workflow.handler.FlowProcessEventHandler;
import net.slion.workflow.mapper.FlwCategoryMapper;
import net.slion.workflow.mapper.FlwInstanceMapper;
import net.slion.workflow.service.IFlwInstanceService;
