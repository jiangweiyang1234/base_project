...
import net.slion.system.domain.SysUserPost;
...
import net.slion.system.domain.vo.SysUserExportVo;
import net.slion.system.domain.vo.SysUserVo;
import net.slion.system.mapper.*;
    ...
    public TableDataInfo<SysUserVo> selectPageUserList(SysUserBo user, PageQuery pageQuery) {
        ...
        if (page != null && page.getRecords() != null && !page.getRecords().isEmpty()) {
            page.getRecords().forEach(item -> {
                ...
                List<SysRoleVo> sysRoleVoList = iSysRoleService.selectRolesByUserId(uid);
                if (CollectionUtil.isNotEmpty(sysRoleVoList)) {
                    item.setRoles(sysRoleVoList);
                }
            });
        }
