...
import net.slion.common.core.constant.CacheNames;
import net.slion.common.core.domain.dto.OssDTO;
...
import net.slion.common.core.utils.file.FileTypeUtils;
import net.slion.common.core.utils.file.FileUtils;
import net.slion.common.core.utils.file.MimeTypeUtils;
...
import net.slion.common.oss.core.OssClient;
import net.slion.common.oss.entity.UploadResult;
import net.slion.common.oss.enums.AccessPolicyType;
import net.slion.common.oss.factory.OssFactory;
import net.slion.system.domain.SysOss;
import net.slion.system.domain.SysOssExt;
import net.slion.system.domain.bo.SysOssBo;
import net.slion.system.domain.vo.SysOssVo;
import net.slion.system.mapper.SysOssMapper;
import net.slion.system.service.ISysOssService;
...
public class SysOssServiceImpl implements ISysOssService, OssService {
    ...
    public SysOssVo upload(MultipartFile file) {
        FileTypeUtils.assertAllowed(file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
