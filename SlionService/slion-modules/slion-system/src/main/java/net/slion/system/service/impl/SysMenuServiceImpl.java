package net.slion.system.service.impl;
...
import net.slion.common.core.utils.TreeBuildUtils;
import net.slion.common.satoken.utils.LoginHelper;
import net.slion.system.domain.SysMenu;
import net.slion.system.domain.SysRole;
import net.slion.system.domain.SysRoleMenu;
import net.slion.system.domain.SysTenantPackage;
import net.slion.system.domain.bo.SysMenuBo;
import net.slion.system.domain.vo.MetaVo;
import net.slion.system.domain.vo.RouterVo;
import net.slion.system.domain.vo.SysMenuVo;
import net.slion.system.mapper.SysMenuMapper;
import net.slion.system.mapper.SysRoleMapper;
import net.slion.system.mapper.SysRoleMenuMapper;
import net.slion.system.mapper.SysTenantPackageMapper;
import net.slion.system.service.ISysMenuService;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            String name = WordUtils.capitalizeFully(menu.getRouteName());
//            String name = menu.getRouteName() + menu.getMenuId();
            RouterVo router = new RouterVo();
            router.setHidden("1".equals(menu.getVisible()));
            if (StringUtils.isNotEmpty(menu.getShowName())) {
                router.setName(menu.getShowName());
            } else {
                router.setName(name);
            }
...
//                router.setRedirect("noRedirect");
                ...
                String frameName = WordUtils.capitalizeFully(menu.getPath());
//                String frameName = StringUtils.capitalize(menu.getPath()) + menu.getMenuId();
                router.setMeta(null);
                List<RouterVo> childrenList = new ArrayList<>();
                RouterVo children = new RouterVo();
                children.setPath(menu.getPath());
                children.setComponent("@/".concat(menu.getComponent()));
                if (StringUtils.isNotEmpty(menu.getShowName())) {
                    children.setName(menu.getShowName());
                } else {
