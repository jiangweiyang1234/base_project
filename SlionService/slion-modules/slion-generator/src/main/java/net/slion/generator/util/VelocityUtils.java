package net.slion.generator.util;
...
import net.slion.common.mybatis.enums.DataBaseType;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("net.slion.common.translation.annotation.Translation");
                importList.add("net.slion.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
